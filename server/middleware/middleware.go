...
import (
	...
	"github.com/shashank/golang-react-todo/models"
...
func DeleteTask(w http.ResponseWriter, r *http.Request) {
	w.Header().Set("Content-Type", "application", "application/x-www.form-urlencoded")
	w.Header().Set("Access-Control-Allow-Origin", "*")
...
func TaskComplete(task string) {
	...
	fmt.Println("mmodified count:",result.ModifiedCount)
}
